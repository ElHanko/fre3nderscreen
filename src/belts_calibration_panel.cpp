...
void BeltsCalibrationPanel::request_emergency_stop()
{
  const auto value =
  ...
  lv_obj_add_event_cb(
      ...
      &BeltsCalibrationPanel::_handle_emergency_prompt,
      LV_EVENT_CLICKED,
      this);
...
void BeltsCalibrationPanel::handle_emergency_prompt(lv_event_t *event)
{
